...
export default function CategoryEdit() {
  const { id } = useParams();
  const { response, loading, error } = useRequest(getCategoryRequest, id);
  ...
  const onSubmit: SubmitHandler<Category> = async (data) => {
    ...
    data.slug = nameSlug;
    const categorySerialized = serialized(data, "categories");
    try {
      await patchCategoryRequest(id, categorySerialized);
  ...
  return (
    <SectionCard title="Editar categoría">
      <FormCard>
